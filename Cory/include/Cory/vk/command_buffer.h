...
class executable_command_buffer {
  public:
    /**
     * to be created from command_buffer::end()!
     */
...
class command_buffer {
  public:
    /**
     * To be created via command_pool::allocate_buffer()!
     */
    ...
    // this is a pure temporary object should neither be moved nor copied
    command_buffer(const command_buffer &) = delete;
    command_buffer &operator=(const command_buffer &) = delete;
    command_buffer(command_buffer &&) = default;
    command_buffer &operator=(command_buffer &&) = default;

    [[nodiscard]] VkCommandBuffer get() noexcept { return cmd_buffer_ptr_.get(); }

    [[nodiscard]] auto &queue() noexcept { return target_queue_; }
    [[nodiscard]] const auto &queue() const noexcept { return target_queue_; }
    ...
    executable_command_buffer end() noexcept
    {
        ...
        return executable_command_buffer{
            std::move(cmd_buffer_ptr_), std::move(pool_ptr_), target_queue_};
    }
  ...
  private:
    std::shared_ptr<VkCommandBuffer_T> cmd_buffer_ptr_;
    std::shared_ptr<VkCommandPool_T> pool_ptr_;
    std::string name_; // currently unused but may be helpful for tracking the timings of specific buffers
    cory::vk::queue *target_queue_;

    /* v~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ AUTOGENERATED CODE ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~v */
  public:

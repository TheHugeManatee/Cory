...
// Modified (naming, namespaces, minor adjustments) from the original available at
...
glm::ivec2 const &CameraManipulator::getMousePosition() const { return m_mousePosition; }
...
glm::ivec2 const &CameraManipulator::getWindowSize() const { return m_windowSize; }

CameraManipulator::Action CameraManipulator::mouseMove(glm::ivec2 const &position,
...
void CameraManipulator::setLookat(const glm::vec3 &cameraPosition, const glm::vec3 &centerPosition,
...
void CameraManipulator::setMousePosition(glm::ivec2 const &position) { m_mousePosition = position; }
...
void CameraManipulator::setWindowSize(glm::ivec2 const &size) { m_windowSize = size; }

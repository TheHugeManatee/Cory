...
std::string Shader::preprocessShader()
{
    ...
    shaderc::PreprocessedSourceCompilationResult result =
        compiler.PreprocessGlsl(m_source.source(), kind, source_name.c_str(), options);
...
std::string Shader::compileToAssembly(bool optimize /*= false*/)
{
    ...
    shaderc::AssemblyCompilationResult result =
        compiler.CompileGlslToSpvAssembly(m_source.source(), kind, source_name.c_str(), options);

...
VkDefaults::PipelineCreator::setViewport(vk::Extent2D swapChainExtent)
{
    ...
    m_viewportState = Cory::VkDefaults::ViewportState(m_viewport, m_scissor);
    return *this;
}

VkDefaults::PipelineCreator &VkDefaults::PipelineCreator::setDefaultRasterizer()
{
...
VkDefaults::PipelineCreator &
VkDefaults::PipelineCreator::setMultisampling(vk::SampleCountFlagBits samples)
{
    m_multisampling = Multisampling(samples);
    return *this;
}

VkDefaults::PipelineCreator &VkDefaults::PipelineCreator::setDefaultDepthStencil()
{
    m_depthStencil = DepthStencil();
    return *this;
}

VkDefaults::PipelineCreator &VkDefaults::PipelineCreator::setAttachmentBlendStates(
    std::vector<vk::PipelineColorBlendAttachmentState> blendStates)
{
    m_attachmentBlendStates = blendStates;
    m_colorBlending = BlendState(&m_attachmentBlendStates);
    return *this;
}

VkDefaults::PipelineCreator &VkDefaults::PipelineCreator::setDefaultDynamicStates()
{
...
VkDefaults::PipelineCreator &
VkDefaults::PipelineCreator::setPipelineLayout(vk::PipelineLayout pipelineLayout)
{
...
vk::UniquePipeline VkDefaults::PipelineCreator::create(GraphicsContext &ctx)
{

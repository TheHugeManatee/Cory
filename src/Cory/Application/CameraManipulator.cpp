                                                       ...
                                                       ModifierFlags &modifiers)
{
    ...
    case MouseButton::Left:
        ...
        else if (modifiers.is_set(ModifierFlagBits::Shift)) {
            curAction = Action::Dolly;
        }
        else if (modifiers.is_set(ModifierFlagBits::Ctrl)) {
...
void CameraManipulator::trackball(glm::i32vec2 const &position)
{
    ...
    if (glm::length(p1 - p0) < 0.0001f) return;
